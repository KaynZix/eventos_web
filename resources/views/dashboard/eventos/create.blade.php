...
<div class="max-w-xl mx-auto p-6">
  ...
  <form method="POST" action="{{ route('dashboard.eventos.store') }}" enctype="multipart/form-data" class="space-y-3">
    @csrf
    ...
    <div>
      ...
      <input name="nombre" value="{{ old('nombre') }}" class="w-full px-3 py-2 rounded bg-neutral-800" required>
    </div>
    ...
    <div class="grid grid-cols-2 gap-3">
      <div>
        ...
        <input type="date" name="fecha" value="{{ old('fecha') }}" class="w-full px-3 py-2 rounded bg-neutral-800" required>
      </div>
      <div>
    ...
    <div class="grid grid-cols-2 gap-3">
      <div>
        ...
        <input type="time" name="hora_inicio" value="{{ old('hora_inicio') }}" class="w-full px-3 py-2 rounded bg-neutral-800" required>
      </div>
      <div>
        <label class="block text-sm mb-1">Hora término</label>
        <input type="time" name="hora_termino" value="{{ old('hora_termino') }}" class="w-full px-3 py-2 rounded bg-neutral-800" required>
      </div>
    </div>
